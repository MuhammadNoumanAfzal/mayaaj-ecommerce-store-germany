            ...
            <div class="grid gap-8 lg:grid-cols-12">
                ...
                <aside id="filter-sidebar" class="lg:col-span-3 hidden lg:block space-y-6">
                    <div class="rounded-md border border-[#e6decb] bg-white p-5 shadow-xs space-y-6">
                        ...
                        <!-- Category Filter -->
                        <div>
                            <h3 class="text-xs font-bold uppercase tracking-wider text-[#1c1210] mb-3" data-i18n-de="Kategorie" data-i18n-en="Category">Kategorie</h3>
                            <div class="space-y-2 text-xs text-[#5c4f46]">
                                ...
                                <label class="flex items-center gap-2 cursor-pointer hover:text-[#78000b] transition">
                                    <input type="checkbox" value="accessories" onchange="applyFilters()" class="category-filter rounded border-[#e6decb] text-[#78000b] focus:ring-0">
                                    <span data-i18n-de="Luxus Accessoires" data-i18n-en="Luxury Accessories">Luxus Accessoires</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer hover:text-[#78000b] transition">
                                    <input type="checkbox" value="golf" onchange="applyFilters()" class="category-filter rounded border-[#e6decb] text-[#78000b] focus:ring-0">
                                    <span data-i18n-de="Golf & Lifestyle" data-i18n-en="Golf & Lifestyle">Golf & Lifestyle</span>
                                </label>
                            </div>
                        </div>
                ...
                <main class="lg:col-span-9">
                    <div id="product-container" class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <article
                            ...
                            data-price="289"
                            data-name="Maison Grand Leather Tote"
                        >
                            ...
                            <div class="card-img-wrap relative h-60 w-full overflow-hidden bg-[#f7f4ee] transition-all duration-300">
                                <img src="/productbag.png" alt="Maison Grand Leather Tote" class="h-full w-full object-cover transition-transform duration-700 ease-out group-hover:scale-108">
                                <div class="absolute left-3 top-3 z-10">
                                    <span class="rounded-sm bg-[#78000b] px-2.5 py-1 text-[0.58rem] font-bold uppercase tracking-luxury text-white shadow-md animate-pulse">BESTSELLER</span>
                                </div>
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <h3 class="mt-2 font-display text-lg font-medium leading-[1.3] text-[#1c1210] group-hover:text-[#78000b] transition-colors duration-300" data-i18n-de="Maison Leder Handtasche" data-i18n-en="Maison Grand Leather Tote">
                                        Maison Leder Handtasche
                                    </h3>
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Handgefertigt aus italienischem Vollleder mit 24k vergoldeten Beschlägen." data-i18n-en="Handcrafted in Italian full grain leather with 24k gold hardware.">Handgefertigt aus italienischem Vollleder mit 24k vergoldeten Beschlägen.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                        <span class="text-base font-bold text-[#1c1210]">EUR 289</span>
                                        <span class="text-[0.65rem] text-[#8a7c74] line-through">EUR 340</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Maison Leder Handtasche', 'EUR 289')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <article
                            ...
                            data-leather="full-grain"
                            data-price="129"
                            data-name="Bespoke Zip Leather Wallet"
                        >
                            <div class="absolute inset-x-0 top-0 z-20 h-1 origin-left scale-x-0 bg-[#d8b45a] transition-transform duration-500 group-hover:scale-x-100"></div>
                            ...
                            <div class="card-img-wrap relative h-60 w-full overflow-hidden bg-[#f7f4ee] transition-all duration-300">
                                ...
                                <div class="absolute left-3 top-3 z-10">
                                    <span class="rounded-sm bg-[#78000b] px-2.5 py-1 text-[0.58rem] font-bold uppercase tracking-luxury text-white shadow-md animate-pulse">NEU</span>
                                </div>
                                <div class="absolute right-3 top-3 z-10 flex flex-col gap-2 opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                                    <button class="flex h-8 w-8 items-center justify-center rounded-full border border-[#e6decb] bg-white text-[#78000b] shadow-md transition hover:bg-[#78000b] hover:text-white cursor-pointer" type="button" onclick="openWishlistModal()" aria-label="Add to wishlist">
                                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    <div class="flex items-center justify-between gap-2">
                                        <p class="text-[0.6rem] font-bold uppercase tracking-[0.18em] text-[#78000b]" data-i18n-de="Geldbörsen & Etuis" data-i18n-en="Wallets & Cases">Geldbörsen & Etuis</p>
                                        <div class="flex text-[#d8b45a] text-[0.65rem] tracking-wider">★ ★ ★ ★ ★</div>
                                    </div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Kompaktes Geldbörsenetui mit RFID-Schutz und 8 Kartenfächern." data-i18n-en="Compact wallet with RFID protection and 8 card slots.">Kompaktes Geldbörsenetui mit RFID-Schutz und 8 Kartenfächern.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Leder Geldbörse Premium', 'EUR 129')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="card-img-wrap relative h-60 w-full overflow-hidden bg-[#f7f4ee] transition-all duration-300">
                                ...
                                <div class="absolute left-3 top-3 z-10">
                                    <span class="rounded-sm bg-[#78000b] px-2.5 py-1 text-[0.58rem] font-bold uppercase tracking-luxury text-white shadow-md animate-pulse">LIMITED</span>
                                </div>
                                <div class="absolute right-3 top-3 z-10 flex flex-col gap-2 opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                                    <button class="flex h-8 w-8 items-center justify-center rounded-full border border-[#e6decb] bg-white text-[#78000b] shadow-md transition hover:bg-[#78000b] hover:text-white cursor-pointer" type="button" onclick="openWishlistModal()" aria-label="Add to wishlist">
                                        <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Edler Schlüsselanhänger aus feinstem Vollleder mit Messingring." data-i18n-en="Refined key ring crafted in full grain leather with brass ring.">Edler Schlüsselanhänger aus feinstem Vollleder mit Messingring.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Executive Schlüsselanhänger', 'EUR 59')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Exklusiver Golf-Reisebegleiter aus wetterfestem Vollleder." data-i18n-en="Exclusive golf carry bag in weather-resistant full grain leather.">Exklusiver Golf-Reisebegleiter aus wetterfestem Vollleder.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Royal Golf Executive Carry', 'EUR 450')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Seidiges Abendkleid mit elegantem Rückenausschnitt." data-i18n-en="Silky evening dress with an elegant back cutout.">Seidiges Abendkleid mit elegantem Rückenausschnitt.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Aurelia Satin Abendkleid', 'EUR 249')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Klassischer Wollmantel mit dezenten Lederelementen am Kragen." data-i18n-en="Classic wool coat with subtle leather collar trims.">Klassischer Wollmantel mit dezenten Lederelementen am Kragen.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Noir Maßmantel', 'EUR 480')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="card-body-wrap p-5 flex flex-col justify-between flex-1 bg-white">
                                <div>
                                    ...
                                    <p class="mt-2 text-xs text-[#685c54] font-light leading-relaxed hidden card-desc" data-i18n-de="Elegante Handtasche in burgunderrotem Saffiano-Leder." data-i18n-en="Elegant handbag in burgundy Saffiano textured leather.">Elegante Handtasche in burgunderrotem Saffiano-Leder.</p>
                                </div>
                                <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[#f2ebdc] pt-4">
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="quickAddToCart('Champagner Lederhandtasche', 'EUR 340')" type="button" class="inline-flex items-center gap-1 rounded bg-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-white shadow-sm transition-all duration-300 hover:bg-[#5a0309] cursor-pointer" data-i18n-de="WARENKORB" data-i18n-en="ADD">WARENKORB</button>
                                        <a href="/shop/maison-leather-tote" class="inline-flex items-center gap-1 rounded border border-[#78000b] px-3 py-2 text-[0.58rem] font-bold uppercase tracking-[0.14em] text-[#78000b] transition-all duration-300 hover:bg-[#78000b] hover:text-white cursor-pointer" data-i18n-de="ANSEHEN" data-i18n-en="VIEW">ANSEHEN</a>
                                    </div>
                                </div>
                            </div>
