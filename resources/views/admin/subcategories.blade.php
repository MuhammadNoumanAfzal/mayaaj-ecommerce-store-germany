...
<div class="space-y-6">
    ...
    <div class="exec-card bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
        ...
        <div class="px-6 py-5 bg-white border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a href="{{ route('admin.subcategories.create') }}" class="btn-exec-primary rounded-xl px-5 py-2.5 text-xs transition-all shadow-md flex items-center gap-2 cursor-pointer" style="background-color: #064e3b !important; color: #ffffff !important; font-weight: 700 !important;">
            ...
            <table class="w-full text-left text-xs">
                <thead>
                    <tr class="exec-table-head bg-slate-100 text-slate-800 font-extrabold uppercase tracking-wider text-[0.7rem] border-y border-slate-300" style="background-color: #f1f5f9 !important; color: #1e293b !important; border-bottom: 2px solid #cbd5e1 !important;">
                        <th class="py-4 px-6 font-black" data-i18n-de="Unterkategorie Name" data-i18n-en="Subcategory Name">Unterkategorie Name</th>
                        <th class="py-4 px-6 font-black" data-i18n-de="Hauptkategorie" data-i18n-en="Parent Category">Hauptkategorie</th>
                ...
                <tbody class="divide-y divide-slate-200 font-medium">
                    @forelse($subcategories as $sub)
                        <tr class="exec-table-row hover:bg-slate-50/90 transition-colors duration-150 border-b border-slate-200/80">
                            ...
                            <td class="py-4 px-6">
                                <span class="inline-flex items-center gap-1.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-800 px-3 py-1 text-xs font-bold shadow-2xs">
                            ...
                            <td class="py-4 px-6">
                                @if($sub->image_url)
                                    <img src="{{ $sub->image_url }}" alt="{{ $sub->name }}" class="h-11 w-11 object-cover rounded-xl border border-slate-300 shadow-2xs transition-transform duration-200 hover:scale-105">
                                @else
