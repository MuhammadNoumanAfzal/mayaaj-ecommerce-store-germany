        ...
        <form action="{{ route('admin.subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 text-xs space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                    <p class="text-[0.68rem] text-slate-500 mt-1 font-semibold" data-i18n-de="Empfohlen: PNG, WebP oder JPG bis 30MB." data-i18n-en="Recommended format: PNG, WebP or JPG up to 30MB.">Empfohlen: PNG, WebP oder JPG bis 30MB.</p>
